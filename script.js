  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        errorMessage = getFieldLabel(field, form) + ' is required.';
      } else if (value !== '') {
        if (type === 'email' && !isValidEmail(value)) {
          ...
          if (value.length < min) {
            errorMessage = getFieldLabel(field, form) + ' must be at least ' + min + ' characters.';
          }
        } else if (field.hasAttribute('maxlength')) {
          const max = parseInt(field.getAttribute('maxlength'), 10);
          if (value.length > max) {
            errorMessage = getFieldLabel(field, form) + ' must be no more than ' + max + ' characters.';
          }
        }
      }
    ...
    animatableElements.forEach(function (el, index) {
      if (!el.hasAttribute('data-delay')) {
        ...
        if (siblingIndex > 0 && siblingIndex < 6) {
          el.setAttribute('data-delay', siblingIndex * 100);
        }
      }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '467ab862-42ae-4624-8ad7-eae18c3658b0',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '467ab862-42ae-4624-8ad7-eae18c3658b0';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to +972523762081 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '467ab862-42ae-4624-8ad7-eae18c3658b0';
